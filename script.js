document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatedElements = document.querySelectorAll(
    '.animate-on-scroll, [data-animate], .feature-card, .section-header, .testimonial-card, .pricing-card, .team-card, .hero-content, .about-content, .service-item, .portfolio-item, .stat-item, .cta-section'
  );
  ...
  if (animatedElements.length > 0 && 'IntersectionObserver' in window) {
    ...
    animatedElements.forEach(function (el, index) {
      ...
      if (!el.dataset.delay && !el.dataset.animateDelay) {
        const siblings = el.parentNode ? el.parentNode.querySelectorAll('.feature-card, .pricing-card, .team-card, .testimonial-card, .stat-item, .service-item, .portfolio-item') : [];
        const siblingArray = Array.from(siblings);
        const siblingIndex = siblingArray.indexOf(el);
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "LampForge uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '50ed4d3f-4c6b-48a9-9de5-684ccb1ca60f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '50ed4d3f-4c6b-48a9-9de5-684ccb1ca60f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '50ed4d3f-4c6b-48a9-9de5-684ccb1ca60f';
